...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(rpath("back.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_post.setPixmap(QtGui.QPixmap(rpath("post.ico")))
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(rpath("search.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(rpath("h3.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
