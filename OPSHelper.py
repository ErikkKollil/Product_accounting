...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def style_table(self):
        ...
        self.tableWidget_BD.horizontalHeader().setStretchLastSection(
            True)  # Установить длинну столбца 3 на всю оставшуюся ширину окна
    ...
    def butt_add(self):
        if len(self.lineEdit_name.text()) > 0:  # Проверка, чтобы наименование товара не было пустым
            if not (self.T_check_in('prod', self.lineEdit_name.text(),
                                    self.lineEdit_date.text())):  # Проверка на дубликаты
                try:
                    ...
                    if datetime.strptime(d2, '%Y-%m-%d') > datetime.strptime('2000-01-01', '%Y-%m-%d'):
                        ...
                        self.T_select_table('prod',
                                            'date')  # Вывод всех данных таблицы с сортировко по порядку добавления
    ...
    def on_click_n(self):
        self.click_one_n() if not self.ongoing_n else self.click_two_n()  # для выполненеия разных действий при нажатии
    ...
    def on_click_d(self):
        self.click_one_d() if not self.ongoing_d else self.click_two_d()  # для выполненеия разных действий при нажатии
    ...
    def update_table(self, data):
        ...
        for nam, i in enumerate(data):
            ...
            elif 30 >= Day_difference >= 1 and i[4] == 0:  # Жельтым: до окончания срока годности 30 дней
...
class WinHist(QtWidgets.QWidget, Ui_History_Windows):
    ...
    def update_table_h(self, data):
        ...
        for nam, i in enumerate(data):
            ...
            elif 10 >= Day_difference >= 1:  # Желтым: до окончания срока годности 10 дней
